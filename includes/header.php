<style>
   ...
   include('./assets/css/searchbarv1.css');
   include('./assets/css/logov1.css');
   include('./assets/css/headermenu.css');
   include('./assets/css/headerv1.css');
   ?>
</style>
...
<header class="header__container">
   ...
   <div class="submenu__container">
      <ul>
         <li>
            <a href="collection.php"><img src="./assets/svg/bookshelf.svg" alt="">Collection</a>
         </li>
         <li>
